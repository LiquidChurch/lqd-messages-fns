...
class LCF_Config_Page
{
    ...
    public function enqueu_js()
    {
        ...
        wp_enqueue_script(
            'block-ui',
            LiquidChurch_Functionality::url("assets/node_modules/block-ui/jquery.blockUI{$min}.js"),
            array('jquery'),
            LiquidChurch_Functionality::VERSION
        );
    ...
    public function enqueu_css()
    {
        ...
        wp_enqueue_style(
            'lc-style-admin',
            LiquidChurch_Functionality::url("assets/css/liquidchurch-style-admin{$min}.css"),
            array(),
            LiquidChurch_Functionality::VERSION
        );
    }

module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            dist: {
                files: {
                    'assets/js/liquidchurch-functionality-admin.min.js': 'assets/js/liquidchurch-functionality-admin.js',
                    'assets/js/liquidchurch-functionality.min.js': 'assets/js/liquidchurch-functionality.js'
                },
